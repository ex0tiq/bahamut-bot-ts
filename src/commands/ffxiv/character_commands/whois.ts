...
const config: CommandConfig = {
    ...
    description: "Get ffxiv character information of a specified user.",
    minArgs: 1,
    expectedArgs: "<user>",
    options: [
        {
...
export default {
    ...
    callback: async ({
                         ...
                         args,
                         interaction,
                     }: { client: BahamutClient, message: Discord.Message, channel: Discord.TextChannel, args: any[], interaction: Discord.CommandInteraction }) => {
