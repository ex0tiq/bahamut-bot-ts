...
async function startup() {
    ...
    let manager = new BahamutShardingManager('./dist/bahamut.js', {
    ...
    let botManager: BahamutShardingBootManager = Object.assign(manager, bootManager);
    // Start db connection
    ...
    //botManager.apiHandler = new BotApiHandler(manager, communication_token);
